...
t_ticket *auto_create_ticket(int date,linklist_ticket list);
...
t_ticket* search_best_ticket_rank(linklist_ticket list);
...
int login(linklist_customer list);

int choice_sore_way(linklist_customer list);

int main_menu(linklist_customer list);

int admin_menu(linklist_customer list);

int customer_menu(m_customer *st,linklist_customer list);
